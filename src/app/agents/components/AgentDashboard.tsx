                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      ...
                      <tr className={`border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
                        ...
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>Modern Villa</td>
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>2 hours ago</td>
                        <td className="py-4 px-1">
                      ...
                      <tr className={`border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
                        ...
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>Coastal Paradise</td>
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>1 day ago</td>
                        <td className="py-4 px-1">
                          <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400 rounded-full text-sm">
                            Offer Made
                          </span>
                      ...
                      <tr className={`border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
                        ...
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>City Penthouse</td>
                        <td className={`py-4 px-1 ${theme === 'dark' ? 'text-dark-text-secondary' : 'text-gray-600'}`}>3 days ago</td>
                        <td className="py-4 px-1">
                          <span className="inline-block px-3 py-1 bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400 rounded-full text-sm">
                            Negotiating
                          </span>
                      ...
                      <div 
                        className={`w-5 h-5 border-2 rounded mt-0.5 cursor-pointer transition-all duration-300 transform hover:scale-110 ${
                          task.completed 
                            ...
                            : 'border-[#F08336] hover:border-[#E07429] hover:bg-orange-50 dark:hover:bg-orange-900/10'
                        }`}
