...
export default function AIChatComponent() {
  ...
  // Voice feature flag via query param (?voice=1)
  const searchParams = useSearchParams();
  const isVoiceEnabled = searchParams.get('voice') === '1';
  ...
  const isFunctionCallingEnabled = searchParams.get('fc') === '1';
    ...
    <>
      ...
      <div className={`container-ai-chat ${isOpen ? 'open' : ''}`} ref={chatRef}>
        <div className="chat">
          ...
          {isFunctionCallingEnabled && searchResults.length > 0 && (
          ...
          {isVoiceEnabled && searchResults.length === 0 && (
